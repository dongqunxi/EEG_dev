...
EEG_dirs = '/home/uais_common/EEG_dev/mats'
factor = 10
fs = 1000 / factor
...
if factor > 1:
    dw_data = signal.decimate(ori_data, q=factor, axis=-1) 
...
# Construct workspace
ws = scot.Workspace({'model_order': 40}, reducedim=8, fs=fs, locations=locs)
