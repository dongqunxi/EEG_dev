...
ws.get_surrogate_connectivity('GPDC', plot=fig2, repeats=rep)
fig2.suptitle('normal control')
ws.show_plots()
...
ws.get_surrogate_connectivity('GPDC', plot=fig1, repeats=rep)
fig1.suptitle('heroin abstinence')
ws.show_plots()